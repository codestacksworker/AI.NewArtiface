...
namespace SING.Data.BaseTools
{
    ...
    public class AppConfig : IConnctionStringConfig, ISavableConfig
    {
        ...
        /// MQ服务器地址
        /// </summary>
        public string RemoteMQServerAddress
        {
            get
            {
                try
                {
                    return _innerConfig.AppSettings.Settings["RemoteMQServerAddress"].Value;
                }
                catch (Exception)
                {
                    MessageBoxHelper.Show("配置文件读取错误！");
                    Logger.Logger.Error("配置节点【RemoteMQServerAddress】读取失败");
                }
                return string.Empty;
            }
            set
            {
                try
                {
                    _innerConfig.AppSettings.Settings["RemoteMQServerAddress"].Value = value;
                }
                catch (Exception)
                {
        ...
        public string DcHost
        {
            get
            {
                try
                {
                    return _innerConfig.AppSettings.Settings["DcHost"].Value;
                }
                catch (Exception)
                {
                    MessageBoxHelper.Show("配置文件读取错误！");
                    Logger.Logger.Error("配置节点【DcHost】读取失败");
                }
                return string.Empty;
            }
            set
            {
                try
                {
                    this._innerConfig.AppSettings.Settings["DcHost"].Value = value;
                }
                catch (Exception)
                {
        ...
        public string DcPort
        {
            get
            {
                try
                {
                    return _innerConfig.AppSettings.Settings["DcPort"].Value;
                }
                catch (Exception)
                {
                    MessageBoxHelper.Show("配置文件读取错误！");
                    Logger.Logger.Error("配置节点【DcPort】读取失败");
                }
                return string.Empty;
            }
            set
            {
                try
                {
                    this._innerConfig.AppSettings.Settings["DcPort"].Value = value;
                }
                catch (Exception)
                {
        ...
        [Browsable(false)]
        public int DcPortInt
        {
            get { return Convert.ToInt32(DcPort); }
        }

        public string DcUrl
        {
            get { return $"http://{DcHost}:{DcPort}"; }
        }
        #endregion
        ...
        public string CoreHost
        {
            get
            {
                try
                {
                    return _innerConfig.AppSettings.Settings["CoreHost"].Value;
                }
                catch (Exception)
                {
                    MessageBoxHelper.Show("配置文件读取错误！");
                    Logger.Logger.Error("配置节点【CoreHost】读取失败");
                }
                return string.Empty;
            }
            set
            {
                try
                {
                    this._innerConfig.AppSettings.Settings["CoreHost"].Value = value;
                }
                catch (Exception)
                {
        ...
        public string CorePort
        {
            get
            {
                try
                {
                    return _innerConfig.AppSettings.Settings["CorePort"].Value;
                }
                catch (Exception)
                {
                    MessageBoxHelper.Show("配置文件读取错误！");
                    Logger.Logger.Error("配置节点【CorePort】读取失败");
                }
                return string.Empty;
            }
            set
            {
                try
                {
                    this._innerConfig.AppSettings.Settings["CorePort"].Value = value;
                }
                catch (Exception)
                {
        ...
        [Browsable(false)]
        public int CorePortInt
        {
            get { return Convert.ToInt32(CorePort); }
        }

        public string CoreUrl
        {
            get { return $"http://{CoreHost}:{CorePort}"; }
        }
        #endregion
